...
def build_periodic_potential(V_depth, k_lattice, x):
    """
    Constructs a periodic potential Hamiltonian:
        V(x) = -V₀ * cos²(k x), where k is the laser wavenumber
    """
    V = -V_depth * (np.cos(k_lattice * x))**2
    return V
